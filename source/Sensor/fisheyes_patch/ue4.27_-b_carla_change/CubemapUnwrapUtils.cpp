...
//////////////////////////// Fisheye helpers and shaders ////////////////////////////

namespace CubemapHelpersFisheye
{
    static bool GenerateLongLatUnwrapFisheye(const FTextureResource* TextureResource, const EPixelFormat SourcePixelFormat, TArray64<uint8>& BitsOUT, FFisheyeParams& FisheyeParams, FIntPoint& SizeOUT, EPixelFormat& FormatOUT)
    {
        TRefCountPtr<FBatchedElementParameters> BatchedElementParameters;
