...
class World(object):
    def __init__(self, carla_world, hud, args):
        ...
        # Traffic Manager port to use when enabling autopilot
        self.tm_port = getattr(args, 'tm_port', 8000)
        self.restart()
...
class KeyboardControl(object):
    ...
    def __init__(self, world, start_in_autopilot):
        ...
        if isinstance(world.player, carla.Vehicle):
            ...
            # Pass TM port to avoid bind conflicts on default port
            world.player.set_autopilot(self._autopilot_enabled, world.tm_port)
            ...
            if event.type == pygame.QUIT:
                ...
                if self._is_quit_shortcut(event.key):
                    ...
                    if self._autopilot_enabled:
                        world.player.set_autopilot(False, world.tm_port)
                        world.restart()
                        world.player.set_autopilot(True, world.tm_port)
                    else:
                        world.restart()
                elif event.key == K_F1:
...
class CameraManager(object):
    def __init__(self, parent_actor, hud, gamma_correction):
        ...
        self.sensors = [
            ...
            ['sensor.camera.fisheye', cc.Raw, 'Camera Fisheye', fisheye_attrs],
...
def main():
    ...
    argparser.add_argument(
        ...
        default=8000,
        type=int,
        help='Traffic Manager port (default: 8000). Use a free port if 8000 is busy.')
    argparser.add_argument(
        '-a', '--autopilot',
        action='store_true',
